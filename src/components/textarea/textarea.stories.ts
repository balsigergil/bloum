...
export const WithContent: Story = {
  render: () => {
    return `
      <div class="max-w-md">
        <textarea class="input" rows="4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</textarea>
      </div>
    `;
  },
};
...
export const Disabled: Story = {
  render: () => {
    return `
      <div class="max-w-md">
        <textarea class="input" rows="4" disabled placeholder="This textarea is disabled"></textarea>
      </div>
    `;
  },
};
...
export const MultipleAutogrow: Story = {
  render: () => {
    return `
      <div class="max-w-md space-y-4">
        <textarea class="input" data-autogrow placeholder="First autogrow textarea"></textarea>
        <textarea class="input" data-autogrow placeholder="Second autogrow textarea"></textarea>
        <textarea class="input" data-autogrow placeholder="Third autogrow textarea"></textarea>
      </div>
    `;
  },
};
