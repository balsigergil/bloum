    ...
    return `
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <label for="pack2" class="card checkbox-card">
          <input type="checkbox" id="pack2" name="pack2" class="checkbox" checked>
    ...
    return `
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        <label for="pack4" class="card checkbox-card">
          <input type="radio" id="pack4" name="pack" value="basic" class="checkbox">
          <img src="https://picsum.photos/id/25/300/200" alt="Nature" class="card-image" />
          <div class="card-header">
            <h3 class="card-title">Basic</h3>
          </div>
        ...
        <label for="pack5" class="card checkbox-card">
          <input type="radio" id="pack5" name="pack" value="pro" class="checkbox" checked>
          <img src="https://picsum.photos/id/27/300/200" alt="Nature" class="card-image" />
          <div class="card-header">
            <h3 class="card-title">Pro</h3>
          </div>
        ...
        <label for="pack6" class="card checkbox-card">
          <input type="radio" id="pack6" name="pack" value="enterprise" class="checkbox" disabled>
          <img src="https://picsum.photos/id/28/300/200" alt="Nature" class="card-image" />
          <div class="card-header">
    ...
    return `
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        <label for="feature1" class="card checkbox-card">
          <input type="checkbox" id="feature1" class="checkbox">
          <div class="card-body">
        ...
        <label for="feature2" class="card checkbox-card">
          <input type="checkbox" id="feature2" class="checkbox" checked>
          <div class="card-body">
        ...
        <label for="feature3" class="card checkbox-card">
          <input type="checkbox" id="feature3" class="checkbox">
          <div class="card-body">
    ...
    return `
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl">
        <label for="billing1" class="card checkbox-card">
          <input type="radio" id="billing1" name="billing" value="monthly" class="checkbox" checked>
          <div class="card-body">
        ...
        <label for="billing2" class="card checkbox-card">
          <input type="radio" id="billing2" name="billing" value="yearly" class="checkbox">
          <div class="card-body">
