export class Select extends HTMLElement {
  ...
  connectedCallback() {
    ...
    indicator.innerHTML = `<svg height="20" width="20" viewBox="0 0 20 20" aria-hidden="true" focusable="false">
    ...
    this.append(this.select, this.input, this.text, indicator, this.menu);
  }
